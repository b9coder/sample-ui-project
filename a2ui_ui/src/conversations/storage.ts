...
// LangGraph checkpointer is in-memory, so this is what makes switching
// back to an older conversation actually show its history.
const KEY_PREFIX = "a2ui_messages_";
